...
public class TemplateReportProvider implements ReportProvider<ReportPage<CatalogReportRow>> {
    private final ReportQueryPort queryPort;

    public String key() { return "catalog.templates"; }
    ...
    public ReportPage<CatalogReportRow> generate(ReportQuery query) { return queryPort.catalog(query, "TEMPLATE"); }
}
